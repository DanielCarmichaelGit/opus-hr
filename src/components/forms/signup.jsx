    ...
    <form onSubmit={handleSubmit} className={governor.Form}>
      ...
      <div className={governor.FormMain}>
        ...
        <InputGroup
          ...
          inputValueChange={setRepeatPassword}
          errors={errors}
        />
      ...
      <div className={governor.FormFooter}>
        <Typography className={governor.FormFooterLinks} variant="caption">Not A Client?</Typography>
        <Typography className={governor.FormFooterLinks} variant="caption">Forgot Password</Typography>
        <Typography className={governor.FormFooterLinks} variant="caption">Terms & Conditions</Typography>
      </div>
    </form>
  );
}
